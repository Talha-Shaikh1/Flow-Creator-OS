...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-[#09090b] text-neutral-100 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-[600px] h-[500px] bg-indigo-600/10 rounded-full blur-[140px] pointer-events-none -translate-y-1/2" />
      ...
      <header className="max-w-7xl mx-auto w-full px-4 sm:px-8 py-6 flex items-center justify-between relative z-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] font-mono text-neutral-400">FlowCreator OS v1.0 Live</span>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto w-full px-4 sm:px-8 py-6 sm:py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10 flex-1">
        ...
        <div className="lg:col-span-6 space-y-6 text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/25 text-indigo-400 text-xs font-bold tracking-wide">
            ...
            <span>Autonomous Video Direction Engine</span>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm sm:text-base text-neutral-400 leading-relaxed max-w-lg">
              Sign in to direct full-week Google Flow Veo video batches with locked spatial anchors, character DNA, and one-click calendar adoption.
            </p>
          </div>
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-neutral-900/60 border border-neutral-800/80">
              ...
              <div>
                <h4 className="text-xs font-bold text-white">7-Day Multi-Episode Production</h4>
                <p className="text-[11px] text-neutral-400">Full 28-clip weekly schedules with Veo 10s continuous camera motion.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-neutral-900/60 border border-neutral-800/80">
              ...
              <div>
                <h4 className="text-xs font-bold text-white">Isolated Cloud Storage</h4>
                <p className="text-[11px] text-neutral-400">Neon Serverless DB guarantees your prompts and characters never mix.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-neutral-900/60 border border-neutral-800/80">
              ...
              <div>
                <h4 className="text-xs font-bold text-white">Zero Data Loss Migration</h4>
                <p className="text-[11px] text-neutral-400">Guest sessions seamlessly claim and migrate to your Google account.</p>
              </div>
            </div>
          </div>
        </div>

        {/* Right Side: The Clerk Sign In Card */}
